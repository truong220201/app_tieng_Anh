      ...
      async listenForItems(itemRef){
        ...
        if(this.thing==`${doc.data().Id_category_dkt}`){
            this.setState({
                ...
                item:[...this.state.item,`${doc.data().Name.slice(3).split('_').join('').split('-').join('')}`],
                                ...
                                return( 
                                    <Animatable.Text animation={fadeIn} style={{width: windowWidth,}} key={n} >
                                        <View key={n} style={{width: windowWidth-20,}}>
                                            ...
                                            <CheckBox
                                                title={<View style={{flexDirection:'row'}}><View style={{width:10}}></View><Text>{this.state.item[n]}</Text></View>}
