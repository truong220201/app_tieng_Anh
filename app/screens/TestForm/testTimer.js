...
class testTimer extends React.Component {
  ...
  return ( 
    ...
    <View style={styles.container}> 
      ...
      <View style={{borderWidth:0,paddingTop:0,flex:2,paddingBottom:0}}>
      ...
      <View style={{flex:this.state.flexQS,borderWidth:0,width: '100%',}}>
        
        <View style={styles.vw2}> 
              <View style={{flex:5,borderWidth:0,width: '100%',}}>
                <ScrollView>
                  <Text style={styles.txtLevel}>Câu 1:Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum </Text>
                </ScrollView>
              </View>
              
        </View>
         <View style={{borderWidth:1,width: '100%',justifyContent:'center',alignItems:'center',borderColor:"black"}}>
      ...
      <View style={{flex:this.state.flexAnw,borderWidth:0,width: '100%',}}>
          <Text>
            Đáp án...
          </Text>
      </View>
