       ...
       />
        ...
        <View style={styles.vw4}>
            <LinearGradient  start={{x: 0, y: 0.75}} end={{x: 1, y: 0.25}} colors={[ '#6bdb91' , '#6bdb91' , '#6bdb91' , '#b9f5dc']}  style={{borderWidth:0,
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('testScreen',{baitap: id,n:1,ten:ten,uid:uid,email:email,itemK:this.itemK,nameqs:this.nameqs,opt0:this.opt0,opt1:this.opt1,opt2:this.opt2,opt3:this.opt3,trueAns:this.trueAns,socau:this.socau,tg:this.tg})} style={{alignItems:'center',}}>
